...
export const AuditoriumHUD: React.FC<AuditoriumHUDProps> = ({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-30 select-none">
      ...
      {/* -------------------------------------------------------------
        EXIT TO LOBBY — TOP LEFT CORNER
    ------------------------------------------------------------- */}
      {(sceneState === 'SEATED' ||
        sceneState === 'OVERVIEW' ||
        sceneState === 'CHANGING_SEAT') && (
          <div className="pointer-events-auto absolute top-2 right-2">
            <button
              ...
              className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl
                     bg-slate-900/85 hover:bg-rose-950/70
                     backdrop-blur-md
                     border border-slate-700/70 hover:border-rose-700/60
      ...
      {(sceneState === 'SEATED' || sceneState === 'OVERVIEW' || sceneState === 'CHANGING_SEAT') && (
        <div className="pointer-events-auto absolute bottom-3 sm:bottom-4 md:bottom-6 left-0 w-full flex items-center justify-center px-1 sm:px-2 animate-in slide-in-from-bottom-4 duration-300">
          {/* Direct POV Switcher */}
